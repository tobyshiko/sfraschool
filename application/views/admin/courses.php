    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Courses Lists</h4>
            </div>
            <div class="card-body">
                ...
                <table id="datatable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        <?php
                            ...
                            if($row->active){
                                $status = '<input type="checkbox" onchange="sfra.clickEnabledDisabled('.$row->courseid.',this)" checked name="checkbox" class="bootstrap-switch"
                                    data-on-label="<i class=\'now-ui-icons ui-1_check\'></i>"
                                    data-off-label="<i class=\'now-ui-icons ui-1_simple-remove\'></i>"
                                />';
                            }else{
                                $status = '<input type="checkbox" onchange="sfra.clickEnabledDisabled('.$row->courseid.',this)" name="checkbox" class="bootstrap-switch"
                                    data-on-label="<i class=\'now-ui-icons ui-1_check\'></i>"
                                    data-off-label="<i class=\'now-ui-icons ui-1_simple-remove\'></i>"
                                />';
                            }
                            ...
                            echo'<tr>
                                ...
                                <td class="text-right">
                                    ...
                                    <a href="#" onclick="sfra.clickEditCourse('.$row->courseid.')" class="btn btn-round btn-warning btn-icon btn-sm edit"><i class="far fa-edit"></i></a>
        ...
        <form id="addCourseForm" action="<?php echo base_url('courses/add_update');?>" method="POST">
          ...
          <div class="modal-body">
                ...
                <div class="row">
                  ...
                  <div class="col-md-8">                          
                      <div class="form-group">
                          <textarea name="coursedesc" class="form-control" maxlength="150" required></textarea>
                      </div>
                  </div>
