        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="toolbar mb-4">
                    <button class="btn btn-primary btn-round" onclick="sfra.clickAddForm()">Compose</button>
                    <a href="<?php echo base_url('notification/sent_messages')?>" class="btn btn-primary btn-round">Sent Messages</a>
                </div>
                <div class="row">
                  <div class="col-md-12">
                    <table id="datatableNoti" class="table" cellspacing="0" width="100%">
                      <thead>
                          <tr>
                ...
                <div class="row">
                  ...
                  <div class="col-md-12">                          
                      <div class="form-group required">
                          ...
                          <select id="useradmin" name="useradmin" class="form-control" required>
                            <option value="" disabled selected>Choose Registered User</option>
                  ...
                  <div class="col-md-12">     
                    <div class="form-group required">
                      ...
                      <textarea name="message" rows="120" maxlength="150" class="form-control" required></textarea>
                    </div>
                  </div>
                </div>
          </div>
